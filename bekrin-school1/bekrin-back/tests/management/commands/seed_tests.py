...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        now = timezone.now()
        end_quiz = now + timedelta(days=7)
        end_exam = now + timedelta(days=7)
        ...
        quiz, _ = Exam.objects.get_or_create(
            ...
            defaults={
                ...
                'start_time': now, 'end_time': end_quiz,
                'duration_minutes': 30, 'max_score': 100,
        ...
        exam, _ = Exam.objects.get_or_create(
            ...
            defaults={
                ...
                'start_time': now, 'end_time': end_exam,
                'duration_minutes': 60, 'max_score': 150,
                'created_by': teacher, 'is_archived': False,
            },
        )
        exam_qs = []
