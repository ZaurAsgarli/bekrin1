...
class Command(BaseCommand):
    ...
    def _create_exams(self):
        ...
        draft_end = draft_start + timedelta(minutes=10)
        ...
        active_quiz_end = now + timedelta(minutes=5)
        ...
        exam_quiz.end_time = active_quiz_end
        ...
        active_exam_end = now + timedelta(minutes=7)
        ...
        exam_exam.end_time = active_exam_end
